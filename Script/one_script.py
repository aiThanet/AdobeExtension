...
print("Step1/4: Adding watermarks and page number to images...")
...
print("Step2/4: Converting images to PDF...")
output_folder = 'C:\\Users\\jpndesign.JPN\\Documents\\ส่งโรงพิมพ์\\00 ต้นฉบับ ลายน้ำ\\'
...
print("Step3/4: Combining PDFs and save...")
merger = PdfWriter()
...
pages = convert_from_path(output_file, dpi=300)
